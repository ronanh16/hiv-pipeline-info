...
[Frequency = 0 indicates that the mutation was called within the quasi-species but with a variable allele frequency of >1%.]{.alert-warning}
```
...
[Frequency = 0 indicates that the mutation was called within at least one quasi-species but with a variable allele frequency of >1% both within that quasi-species and in the general viral population.]{.alert-warning}
```
